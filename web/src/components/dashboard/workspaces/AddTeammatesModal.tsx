...
const MODAL_TRANSITION_ENTER = "ease-out duration-300";
const MODAL_TRANSITION_LEAVE = "ease-in duration-200";

export default function AddTeammatesModal() {
    const { themeColors } = useTheme();
    const cancelButtonRef = useRef(null);
    const { openInviteTeammates: open, setOpenInviteTeammates: setOpen } = useModal();
        ...
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <Transition.Child
                        as={Fragment}
                        enter={MODAL_TRANSITION_ENTER}
                        enterFrom="opacity-0"
                        enterTo="opacity-100"
                        leave={MODAL_TRANSITION_LEAVE}
                        ...
                        >
                            ...
                            <Formik
                                ...
                                onSubmit={async ({ email }, { setSubmitting }) => {
                                    setSubmitting(true);
                                    try {
                                        await postData(`/workspaces/${workspaceId}/members`, { email });
