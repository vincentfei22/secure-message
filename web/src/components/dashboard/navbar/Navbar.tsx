...
export default function Navbar() {
    ...
    const { setOpenPreferences, setOpenEditPassword } = useModal();
    const navigate = useNavigate();
    const location = useLocation();
    const profile = location.pathname?.includes("user_profile");
    const { userdata } = useUser();
    const photoURL = getHref(userdata?.thumbnailURL) || getHref(userdata?.photoURL);
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            backgroundImage: `url(${photoURL || `${process.env.PUBLIC_URL}/blank_user.png`
                                                })`,
                                        }}
                                    />
                                </Menu.Button>
